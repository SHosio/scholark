...
For brainstorming, critique, and literature blind spot analysis to use real published papers, install the [Scholark-1](https://github.com/SHosio/scholark-1) MCP server in your research project:
...
For mechanical prose tightening (splitting long sentences, cutting fluff, fixing nominalizations), use the `prose-tighten` skill. It is `.tex` only and leaves field-specific terminology alone, asking you when uncertain.
